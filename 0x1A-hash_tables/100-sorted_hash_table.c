...
/**
 * set_pair - malloc a key/value pair to the sorted hash table.
...
/**
 * shash_table_set - adds or udates an element to the sorted hash table.
 * @ht: pointer to the sorted hash table.
 * @key: the key, a string that cannot be empty.
 * @value: the value associated with the key, can be an empty string.
 *
...
/**
 * shash_table_get _ retrieves a value associated with a key.
